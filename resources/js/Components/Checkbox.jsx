export default function Checkbox({ className = "", id, label, ...props }) {
    return (
        <label htmlFor={id} className="relative inline-flex items-center cursor-pointer">
            ...
            <div
                className="w-11 h-6 bg-slate-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-ilyes
        dark:peer-focus:ring-ilyes rounded-full peer dark:bg-slate-700 peer-checked:after:translate-x-5
