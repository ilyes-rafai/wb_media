            ...
            {user && user ? (
                <>
                    ...
                    <NavLink
                        ...
                        active={route().current("trickList")}
                    >
                        <i className="fa-solid fa-code me-2 text-lg"></i>
                        {translations.Tricks}
                    </NavLink>
                    ...
                    <NavLink
                        href={route("courseList")}
                        active={route().current("courseList")}
                    >
                        <i className="fa-solid fa-video me-2 text-lg"></i>
                    ...
                    <NavLink
                        href={route("exerciceList")}
                        active={route().current("exerciceList")}
                    >
                    ...
                    <NavLink
                        href={route("vocabularyList")}
                        active={route().current("vocabularyList")}
                    >
